...
#        print last, last
        ...
        if last == 'A':
            replace = ['A','R','M','W','H','V','D','N']

        elif last == 'T':
            replace = ['T','Y','K','W','H','B','D','N']

        elif last == 'C':
            replace = ['C','Y','M','S','H','B','V','N']

        elif last == 'G':
            replace = ['G','R','K','S','B','V','D','N']

        else:
            replace = [last]

        letters = replace if p.mismatches == 0 else alphabet
